function t396_init(e) {
  ...
  d &&
        ...
        t396_waitForFinalEvent(
          function () {
            window.t396__isMobile || n
              ...
              : a && t396_isBlockVisible(a) && (t396_doResize(e), d.classList.remove("t396_resizechange"));
          },
          500,
          "resizeruniqueid" + e
        );
    ...
    /^((?!chrome|android).)*safari/i.test(navigator.userAgent) && l && l.classList.add("t396_safari"),
...
function t396__initOnlyScalable() {
  ...
  void 0 === window.isOnlyScalable &&
    ...
    (i = ((i = window.navigator.userAgent.match(/Chrome\/([0-9]+)\./)) && parseInt(i[1], 10)) || 0),
...
function t396__setGlobalScaleVariables(t, e, i) {
  ...
  t = "ab" + t;
  i
    ? ((window.tn[t].scaleFactor = parseFloat((window.tn_window_width / e).toFixed(3))),
      (window.tn_scale_factor = parseFloat((window.tn_window_width / e).toFixed(3))))
        ...
        ? ((r = i ? i.querySelectorAll(".tn-molecule, .tn-atom") : []),
          Array.prototype.forEach.call(r, function (t) {
            ...
            (t.classList.contains("tn-atom") && t.closest(".tn-molecule")) ||
              ((i = (e = t.closest(".tn-atom__scale-wrapper")) ? e.parentNode : null) && i.removeChild(e),
              i && i.appendChild(t));
          }))
...
function t396_detectResolution(t) {
  ...
  if (t)
    return (
      (t = "ab" + t),
      (e = window.innerWidth),
      (window.t396__isMobile || window.t396__isIPad) && (e = document.documentElement.clientWidth),
...
function t396_updateTNobj(t) {
  for (
    ...
    window.tn[i].curResolution === n[o] &&
      ...
      (window.tn[i].canvas_max_width = 0 === o ? window.tn.window_width : n[o - 1]));
  (window.tn[i].grid_width = window.tn[i].canvas_min_width),
    (window.tn[i].grid_offset_left = (window.tn.window_width - window.tn[i].grid_width) / 2);
}
...
function t396_artboard_build(t, e) {
  ...
  ("visible" !== a && "visibleX" !== a) ||
    ...
    "auto" === a && 0 !== (r = Math.abs(o.offsetHeight - o.clientHeight)) && (o.style.paddingBottom = r + "px"),
...
function t396_ab__renderView(t) {
  if (!t) return !1;
  for (var e = window.tn.ab_fields, i = document.getElementById("allrecords"), n = 0; n < e.length; n++)
...
function t396_addText(t, e) {
  (e = t396_getEl(e)) &&
    (e.setAttribute("data-fields", "top,left,width,container,axisx,axisy,widthunits,leftunits,topunits"),
...
function t396_processElemTransform(t) {
  ...
  !(
    ...
    ("none" !==
      (e =
        "matrix(1, 0, 0, 1, 0, 0)" ===
        (e = (i = t.querySelector(".tn-atom")) ? window.getComputedStyle(i).transform : "none")
          ? "none"
          : e) &&
...
function t396_addButton(t, e) {
  if ((e = t396_getEl(e)))
    return (
      e.setAttribute("data-fields", "top,left,width,height,container,axisx,axisy,caption,leftunits,topunits"),
      t396_elem__renderView(e),
      t396_processElemTransform(e),
      e
    );
...
function t396_elem__convertPosition__Local__toAbsolute(t, e, i) {
  if ((t = t396_getEl(t))) {
    var n = t.closest(".t396__artboard"),
      ...
      h = (n && (g = "grid"), (i = parseInt(i)), t396__getCurrentScaleFactor(o));
    switch (e) {
      case "left":
        ...
        !d && l ? "grid" === g && _ && (i *= h) : (i = b + i),
          "center" === w &&
            ((x = t396_elem__getWidth(t)), s && "window" !== f && ((y *= h), (x *= h)), (i = y / 2 - x / 2 + i)),
          "right" === w && ((x = t396_elem__getWidth(t)), s && "window" !== f && ((y *= h), (x *= h)), (i = y - x + i)),
          s && "window" !== f && (i += ((x = t396_elem__getWidth(t)) * h - x) / 2);
        break;
      case "top":
        function v(t) {
          var e,
        ...
        if (
          ...
          "%" === t396_elem__getFieldValue(t, "topunits") && (i = y * (i / 100)),
          m)
        ) {
        ...
        s && "window" !== f && (i *= h), (i = (b = u && "window" !== f ? ("stretch" === a ? 0 : b / h) : b) + i);
        var A,
          V,
        ...
        l && !d && x && (A = parseInt(b, 10) * h),
          "center" === c &&
            ((V = v(t)),
            s && "window" !== f && ("stretch" !== a ? (y *= h) : (y = A ? (S < A ? A : S) : F.clientHeight), (V *= h)),
            d || !l || _ || "window" === f || "stretch" !== a || ((y = A ? (S < A ? A : S) : F.clientHeight), (y /= h)),
            (i = y / 2 - V / 2 + i)),
          "bottom" === c &&
            ((V = v(t)),
            s && "window" !== f && ("stretch" !== a ? (y *= h) : (y = A ? (S < A ? A : S) : F.clientHeight), (V *= h)),
            d || !l || _ || "window" === f || "stretch" !== a || ((y = A ? (S < A ? A : S) : F.clientHeight), (y /= h)),
            (i = y - V + i)),
          s && "window" !== f && ((x = ((V = v(t)) * h - V) / 2), (i += x = Math.round(x)));
    }
    return i;
  }
}
    ...
    if (null === l)
      for (var d = 0; d < a.length; d++) {
        ...
        if (
          !(_ <= o) &&
          null !==
            (l = _ === r ? t.getAttribute("data-artboard-" + e) : t.getAttribute("data-artboard-" + e + "-res-" + _))
        )
          break;
      }
    return l;
...
function t396_group__getFieldValue(t, e) {
  if (t) {
    var i = "ab" + t.closest(".t396__artboard").getAttribute("data-artboard-recid"),
      ...
      a = n === o ? t.getAttribute("data-group-" + e + i) : t.getAttribute("data-group-" + e + "-res-" + n + i);
    if (null === a)
...
function t396_elem__getHeight(t, e) {
  ...
  return (
    "shape" === o || "video" === o || "html" === o || "gallery" === o || "button" === o
      ? "%" === t396_elem__getFieldValue(t, "heightunits") &&
        ((i = (n = t.closest(".t396__artboard")) ? n.getAttribute("data-artboard-proxy-min-height") : "0"),
        (n = n ? n.getAttribute("data-artboard-proxy-max-height") : "0"),
        (i = parseFloat(i)),
        (n = parseFloat(n)),
        (e = "window" === t396_elem__getFieldValue(t, "container") ? n * (e / 100) : i * (e / 100)))
      : ("text" === o && (n = t.querySelector(".tn-atom")) && (n.style.lineHeight = ""), (e = t.clientHeight)),
    e
  );
}
