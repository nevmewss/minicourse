...
function t_animate__preventHorizontalScroll() {
  ...
  !Array.prototype.filter.call(t, function (t) {
    ...
    ((t = document.querySelector(".t-records")) && (t.style.overflowX = "hidden"));
}
  ...
  return (
    Array.prototype.forEach.call(t, function (t) {
      t.classList.contains("t396__artboard") &&
        ((t = (t = (t = (t = t.getAttribute("data-artboard-screens")) ? t.split(",") : [1200, 960, 640, 480, 320]).map(
          function (t) {
...
function t_animate__startAnimation() {
  ...
  (o = Array.prototype.filter.call(o, function (t) {
    ...
    window.innerWidth < 1200 &&
      ((i = t_animate__checkMobile(i)), (r = t_animate__checkMobile(r)), (o = t_animate__checkMobile(o))),
                    ...
                    t.forEach(function (t) {
                      ...
                      !a.demandTransform && a.style.transform
                        ...
                        : ((e = window.getComputedStyle(a).transform),
                          a.style.transform ||
                            "none" === e ||
                            ((a.demandTransform = e), (a.style.transform = "unset"))),
                        t.isIntersecting &&
                          (a.closest(".t1093") || n.unobserve(a),
                          (e =
                            -1 !== (e = a.style.transitionDelay || "0ms").indexOf("ms")
                              ? parseInt(e) + 250
        ...
        a &&
          a.addEventListener(
            ...
            t_throttle(function () {
              ...
              ((a.classList.contains("t-animate") && "yes" === a.getAttribute("data-animate-chain")) ||
...
function t_animate__deleteAnimatedEls(t, e) {
  ...
  return (
    ...
    e.forEach(function (t) {
      t.curTopOffset <= a
        ? (t_animate__removeAnimationClass(t, ["wait", "no-hover"]), t_animate__setStartAnimationClass(t, !1))
        : i.push(t);
    }),
    [i, n]
  );
...
function t_animate__getDelayFromPreviousScrollEvent(t, e) {
  ...
  return a || !t.length
    ? 0
    : t.length
    ? (a = (t[t.length - 1].getAttribute("data-animate-start-time") || 0) - Date.now()) <= 0
      ? e
      : a / 1e3 + e
    : void 0;
}
function t_animate__setStartAnimationClass(t, e) {
  var a;
  t &&
    (e && (a = t.closest("." + (e = "t-animate-for-wrapper"))) && a.classList.remove(e),
...
function t_animate__catchTransitionEndEvent(t) {
  ...
  Array.prototype.forEach.call(t, function (e) {
    ["transitionend", "webkitTransitionEnd", "oTransitionEnd", "otransitionend", "MSTransitionEnd"].forEach(function (
      t
    ) {
    ...
    y =
      ...
      c.forEach(function (t, e) {
        ...
        null !== _ &&
          ...
          -1 !== t.indexOf(".") && (a = t.split(".")),
          (-1 === t.indexOf(",") && -1 === t.indexOf(".")) || ((f = a[1].length), (c[e] = +a.join(".")), (u = !0)));
      }),
...
function t_animate__getAttrByResBase(t, e) {
  ...
  var i,
    ...
    o =
      void 0 !== window.tn[n]
        ? ((i = window.tn[n].curResolution), (r = window.tn[n].curResolution_max), window.tn[n].screens.slice())
  ...
  if (!a && "" !== a)
    for (var s = 0; s < o.length; s++) {
      ...
      if (
        !(l <= i) &&
        (a = l === r ? t.getAttribute("data-animate-" + e) : t.getAttribute("data-animate-" + e + "-res-" + l))
      )
        break;
    }
  return a;
...
function t_animation__getZoom(t) {
  ...
  return t.classList.contains("t396__artboard_scale") ||
    (!e && "undefined" != typeof t396_ab__getFieldValue && "window" === t396_ab__getFieldValue(t, "upscale"))
